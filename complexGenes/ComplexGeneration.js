...
class ComplexGeneration {
     ...
     createBias() {
        ...
        for (let i = 0; i < this.geneNum; i++) {
            updateRankingsX[i] = 1 - updateRankingsX[i]/(this.geneNum-1);
            updateRankingsY[i] = 1 - updateRankingsY[i]/(this.geneNum-1);
        }
        ...
        for (let i = 0; i < this.steps; i++) {
            ...
            for (let j = 0; j < this.geneNum; j++) {
                sumMovesX += updateRankingsX[j] * this.genes[j].geneMoves[i][0];
